...
#                                                                              #
# Description:                                                                 #
# This class is meant to be more of a blackbox, but you are allowed to see the #
# implementation. You are not allowed to change anything in this file. There   #
# is also no need to base your algorithms on this particular implementation.   #
#                                                                              #
#                                                                              #
# Notes:                                                                       #
