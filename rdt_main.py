...
# ##############################################################################
# The following are two sets of data input to the communication test. The first
# is small and the second is longer. Start by trying the shorter one until you
# feel you have a good algorithm. Then confirm it still works on a larger scale
# by switching to the larger.                                                  #
# ##############################################################################
